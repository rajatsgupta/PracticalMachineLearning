...
These are the files produced during a homework assignment of Coursera's MOOC Practical Machine Learning from Johns Hopkins University. The brief introduction is as follows:
...
The data for this project comes from this original source [http://groupware.les.inf.puc-rio.br/har](http://groupware.les.inf.puc-rio.br/har) and I thank them for their generosity in allowing their data to be used for this kind of assignment.

### Project Intended Results

- The goal of this project is to predict the manner in which the personel did the exercise
- Machine Algorithm applied to 20 test cases available in the test data above.
...
```{r}
# Set the training set URL
trainUrl <- "http://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv"

# Set the test set URL
